...
class Config(MyConfig):
    def __init__(self):
        ...
        # optimizer
        self.train.batch_size = 128  # Reduced batch size for video processing
        ...
        TinyNAS_Temporal = {
            ...
            'num_frames': 4,  # Number of frames to process together
            'temporal_stages': [3, 4],  # Apply temporal fusion at stages 3 and 4
            'fusion_type': 'conv3d',  # Options: 'conv3d', 'avg', 'attention'
        }

        self.model.backbone = TinyNAS_Temporal
